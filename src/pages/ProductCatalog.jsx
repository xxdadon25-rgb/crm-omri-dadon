...
export default function ProductCatalog() {
  ...
  return (
    <div>
      ...
      {/* OLD - can restore: remove this wrapper div and its closing tag, restore children as direct siblings */}
      <div className="overflow-y-auto thin-scrollbar max-h-[calc(100vh-8rem)]">
        ...
        {/* Sticky search bar — sticks within the scrollable wrapper above */}
        ...
        <div className="flex flex-row gap-6 items-start">
          ...
          <aside className="hidden lg:flex flex-col w-56 shrink-0 bg-white rounded-lg shadow-sm border border-gray-100 overflow-hidden sticky top-[4.5rem]">
